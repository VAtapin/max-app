...
async def configure_telegram_menu(bot) -> None:
    await bot.set_my_commands(
        [
            ...
            BotCommand(command="products", description="Каталог продуктов"),
            BotCommand(command="product", description="Найти продукт"),
            BotCommand(command="recommendations", description="Мои рекомендации"),
