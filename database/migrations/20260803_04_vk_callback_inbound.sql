...
('Как подключить VK-сообщество', 'Для VK нужен ключ доступа сообщества и Callback API. Ключ доступа отправляет ответы клиентам, а Callback API принимает входящие сообщения из лички сообщества.', JSON_ARRAY(
  'В VK откройте сообщество и перейдите в Управление.',
  ...
  'В Управление -> Дополнительно -> Работа с API -> Ключи доступа создайте ключ с правами: управление сообществом, сообщения сообщества, фотографии, документы, истории и стена.',
