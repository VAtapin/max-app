...
DROP TABLE IF EXISTS subscription_period_discounts;
...
CREATE TABLE subscription_plans (
  ...
  payment_grace_days INT UNSIGNED NOT NULL DEFAULT 5,
...
CREATE TABLE vk_message_permissions (
  id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  end_user_id BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE subscription_period_discounts (
  id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  ...
  CONSTRAINT fk_subscription_period_discount_plan FOREIGN KEY (subscription_plan_id) REFERENCES subscription_plans(id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE workspace_subscriptions (
  ...
  CONSTRAINT fk_workspace_subscription_root FOREIGN KEY (root_reseller_id) REFERENCES resellers(id) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fk_workspace_subscription_plan FOREIGN KEY (subscription_plan_id) REFERENCES subscription_plans(id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE billing_invoices (
  ...
  CONSTRAINT fk_billing_invoice_workspace FOREIGN KEY (workspace_subscription_id) REFERENCES workspace_subscriptions(id) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fk_billing_invoice_root FOREIGN KEY (root_reseller_id) REFERENCES resellers(id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE payment_transactions (
  ...
  CONSTRAINT fk_payment_transaction_invoice FOREIGN KEY (billing_invoice_id) REFERENCES billing_invoices(id) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fk_payment_transaction_method FOREIGN KEY (payment_method_id) REFERENCES payment_methods(id) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT fk_payment_transaction_admin FOREIGN KEY (confirmed_by) REFERENCES admin_users(id) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE billing_adjustments (
  ...
  created_by BIGINT UNSIGNED NULL,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_billing_adjustment_workspace FOREIGN KEY (workspace_subscription_id) REFERENCES workspace_subscriptions(id) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fk_billing_adjustment_admin FOREIGN KEY (created_by) REFERENCES admin_users(id) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO payment_methods (code, title, method_type, description, is_test, is_active, sort_order) VALUES
...
INSERT INTO subscription_period_discounts (subscription_plan_id, months, discount_percent, badge_text, is_active, sort_order)
